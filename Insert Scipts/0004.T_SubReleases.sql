...
INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.1.0'),'ST1',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'Tested'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.1.0'),'ST2',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'In QA'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.2.0'),'ST1',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'UAT'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.2.0'),'ST2',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'Tested'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.1.0 SP1'),'S1 ',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'In QA'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.1.0 SP1'),'S2 ',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'Dev Complete'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.2.0 SP2'),'S1',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'Dev Complete'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.2.0 SP2'),'S2',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'In Progress'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.1.0 WL1'),'R1',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'UAT'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.1.0 WL1'),'R2',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'Tested'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.2.0 WL2'),'R1',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'In QA'),CURRENT_TIMESTAMP)

INSERT INTO [dbo].[T_SubReleases](C_ReleaseID,C_SubReleaseName,C_StatusID,C_LastModified)
VALUES((SELECT C_ReleaseID FROM T_Releases WHERE C_ReleaseName = '17.2.0 WL2'),'R2',
(SELECT C_StatusID FROM T_Status WHERE C_StatusName = 'Dev Complete'),CURRENT_TIMESTAMP)
